...
class LiDAR_prior_factor_15 : public ceres::SizedCostFunction<15, 7, 9>
{
  public:
    ...
    virtual bool Evaluate(double const *const *parameters, double *residuals, double **jacobians) const
    {
        ...
        Eigen::Vector3d Pi(parameters[0][0], parameters[0][1], parameters[0][2]); //position 
        Eigen::Quaterniond Qi(parameters[0][6], parameters[0][3], parameters[0][4], parameters[0][5]); //rotation 
