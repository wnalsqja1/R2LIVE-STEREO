...
queue<sensor_msgs::CompressedImageConstPtr> img2_buf;
std::mutex m_buf;
...
void img_callback2(const sensor_msgs::CompressedImageConstPtr &img_msg){
    m_buf.lock();
...
int main(int argc, char **argv)
{
    ...
    get_ros_parameter<std::string>(n, "image1_topic", IMAGE1_TOPIC, "/cam0/compressed");
    get_ros_parameter<std::string>(n, "image2_topic", IMAGE2_TOPIC, "/cam1/compressed");
